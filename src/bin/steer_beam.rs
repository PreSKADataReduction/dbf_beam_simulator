...
use scorus::{
    coordinates::{rotation3d::RotMatrix, vec3d::Vec3d},
    healpix::rotation::rotate_ring,
};
...
fn main() {
    ...
    let (hp_data, rot) = if let Some(fname) = matches.value_of("beam") {
